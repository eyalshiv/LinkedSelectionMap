...
% gFocSites - positions of neutral sites where the SW coefficient is calculated, in genetic distance. This may be only a grid of focal sites, and exact values for other sites can be interpolated at higher levels (beyond this function)
